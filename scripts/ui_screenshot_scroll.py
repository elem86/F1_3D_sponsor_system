...
scroll_value = float(sys.argv[3]) if len(sys.argv) > 3 else 0.5
output = sys.argv[4] if len(sys.argv) > 4 else "generated/debug/ui_scroll_test.png"
...
viewer.ui.slot_scroll.verticalScroll["value"] = scroll_value
